# Nicholas Borges de Vasconcelos
...
| Semester | Project | Course | Stack | |
|----------|---------|--------|-------|--|
| 2026.1 | [Face Search App](https://github.com/nicholas-vasconcelos/face-search-app) | Research — SBrT | Python · face_recognition · Docker · AWS | [↗](https://github.com/nicholas-vasconcelos/face-search-app) |
| 2026.1 | [Humanizing Choice](https://github.com/nicholas-vasconcelos/humanization-layer-survey-project) | Research (Supervisor: Prof. Rigel) | Django · Groq LLM · Supabase · AWS EB | [↗](http://humanizing-catalogue-survey-env.eba-kg3w4fxe.us-east-1.elasticbeanstalk.com/) |
| 2026.1 | [Banco Master Stock Timeline](https://github.com/nicholas-vasconcelos/projeto-timeline-banco-master) | Data Extraction and Preparation | Django · React · Ollama · ChromaDB | [↗](https://projeto-timeline-banco-master.vercel.app/) |
| 2026.1 | [Rio Bus Data Tracker](https://github.com/nicholas-vasconcelos/onibus-rj-dados-tracker) | Data Extraction and Preparation | Python · Streamlit · Folium | [↗](https://onibus-rj-dados-tracker.streamlit.app/) |
